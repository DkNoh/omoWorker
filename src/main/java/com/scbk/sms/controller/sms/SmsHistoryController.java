...
public class SmsHistoryController {
  ...
  @PrivacyLog(action = "발송이력조회 목록 조회", recordParameters = false)
  @ResponseBody
  @GetMapping("/data")
  ...
  @PrivacyLog(action = "발송이력조회 엑셀 다운로드")
  @GetMapping("/excel")
  ...
  @PrivacyLog(action = "발송이력조회 원문 상세 조회")
  @ResponseBody
  @GetMapping("/unmask")
  public ResponseEntity<ApiResponse<SmsHistoryVO>> getUnmaskedDetail(
      @RequestParam Integer smsHistoryId) {
