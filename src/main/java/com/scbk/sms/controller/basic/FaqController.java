...
public class FaqController {
    ...
    @ResponseBody
    @GetMapping("/data")
    public ResponseEntity<ApiResponse<PageResponseDTO<FaqVO>>> getData(
            @ModelAttribute FaqSearchRequestDTO request) {
        return ResponseEntity.ok(ApiResponse.success(service.search(request)));
    }

    @ResponseBody
    @PostMapping("/create")
    public ResponseEntity<ApiResponse<String>> create(@Valid @RequestBody FaqUpdateRequestDTO request) {
    ...
    @ResponseBody
    @PostMapping("/update")
    public ResponseEntity<ApiResponse<String>> update(@Valid @RequestBody FaqUpdateRequestDTO request) {
