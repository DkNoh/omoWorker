...
import com.scbk.sms.mapper.basic.DepartmentMapper;
...
class DepartmentServiceTest {
  ...
  @Mock private DepartmentMapper mapper;
  ...
  void 목록_조회는_페이지_응답으로_감싼다() {
    ...
    given(mapper.selectList(request)).willReturn(List.of(new DepartmentVO()));

    // when
    PageResponseDTO<DepartmentVO> result = service.search(request);
